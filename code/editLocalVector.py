...
def edit_local_vector():
    ...
    for x in range(- math.floor(con.channel_exit_influence / 2) + 1, math.floor(con.channel_exit_influence / 2) + 1):
        for y in range(-math.floor(math.sqrt(abs(math.floor(con.channel_exit_influence/2)^2-x^2))), math.floor(math.sqrt(abs(math.floor(con.channel_exit_influence/2)^2-x^2)))):
    ...
    for x in range(- math.floor(con.nest_influence / 2) + 1, math.floor(con.nest_influence / 2) + 1):
        for y in range(- math.floor(math.sqrt(abs(math.floor(con.nest_influence/2)^2-x^2))), math.floor(math.sqrt(abs(math.floor(con.nest_influence/2)^2-x^2)))):
